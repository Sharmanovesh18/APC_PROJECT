...
public class QuizDAOImpl implements QuizDAO {
    ...
    public int createQuiz(Quiz quiz) {
        return jdbc.update(
            "INSERT INTO quizzes (quiz_id, title, description) VALUES (quiz_seq.NEXTVAL, ?, ?)",
    ...
    public int updateQuiz(Quiz quiz) {
        return jdbc.update(
            ...
            quiz.getTitle(), quiz.getDescription(), quiz.getQuizId()
        );
    }

    @Override
    public int deleteQuiz(int quizId) {
        return jdbc.update("DELETE FROM quizzes WHERE quiz_id = ?", quizId);
    }
    ...
    public int updateQuestion(Question q) {
        return jdbc.update(
            ...
            q.getOptionC(), q.getOptionD(), String.valueOf(q.getCorrectOption()),
            q.getQuestionId()
        );
    }
    ...
    public int deleteQuestion(int questionId) {
        return jdbc.update("DELETE FROM questions WHERE question_id = ?", questionId);
    }
}
